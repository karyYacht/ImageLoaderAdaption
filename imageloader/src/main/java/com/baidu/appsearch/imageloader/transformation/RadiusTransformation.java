package com.baidu.appsearch.imageloader.transformation;
...
import com.baidu.appsearch.imageloader.util.Utils;
...
import static com.baidu.appsearch.imageloader.transformation.RadiusTransformation.CornerType.ALL;

/**
 * @author by sunfusheng on 2017/6/6.
 */
public class RadiusTransformation implements Transformation<Bitmap> {
    ...
    public RadiusTransformation(Context context, int radius) {
        mBitmapPool = GlideApp.get(context).getBitmapPool();
        mCornerType = ALL;
        mRadius = Utils.dp2px(context, radius);
        mDiameter = 2 * mRadius;
    }

    public RadiusTransformation(Context context, int radius, CornerType type) {
        mBitmapPool = GlideApp.get(context).getBitmapPool();
        mCornerType = type;
        mRadius = Utils.dp2px(context, radius);
        mDiameter = 2 * mRadius;
